...
## Agentenstrategie — Hypothesen zuerst

Die gemeinsame Arbeitsabsprache wird ab 2026-09-25 explizit als Projektregel geführt:

**Kostenfreie Agentenressourcen werden primär für Hypothesenbildung, Gegenhypothesen, Mechanismensynthese und Forschungsdesign eingesetzt.** Deterministische Berechnung bleibt lokal. Bezahlte Agenten-/API-Nutzung bleibt deaktiviert.

Der erste vorgesehene Agentenauftrag ist eine gebündelte, orthogonale Hypothesenrunde auf Basis der eingefrorenen Failure-Diagnose T041/T042/T044/T045 und Q011. Die Ausgabe ist Ideenmaterial; keine Holdout-Auswahl, keine rückwirkende Trial-Optimierung und keine automatische Promotion.

Dauerhafte Spezifikation: docs/AGENT_HYPOTHESIS_RESEARCH.md.

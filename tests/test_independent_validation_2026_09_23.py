...
def test_new_validation_universes_are_fully_disjoint_from_prior_universes():
    _assert_global_disjoint()


def test_new_validation_universes_have_fixed_expected_shapes():
...
def test_new_validation_symbols_are_exactly_preregistered():

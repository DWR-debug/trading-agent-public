...
def test_third_validation_universes_are_fully_disjoint():
    _assert_global_disjoint()


def test_third_validation_shapes_are_fixed():
...
def test_third_validation_symbols_are_exactly_preregistered():

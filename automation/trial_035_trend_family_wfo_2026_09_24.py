...
def run_validation(data_dir,manifest_path,output_path):
    ...
    report={
      ...
      "source":{"universe":UNIVERSE,"symbols":list(assets),"target_candles":TARGET_COUNT,"research_count":RESEARCH_COUNT,"holdout_count":HOLDOUT_COUNT,
                "fully_symbol_disjoint":True,"coverage_preflight_workflow":36046054250,"coverage_preflight_artifact":10829105161,
                "coverage_preflight_digest":"sha256:c48cac3262719b2178011a93f62568193a9e2967d7dc756cb259828d6942a0fa4",
                "coverage_preflight_common_calendar_count":3520,"manifest_fingerprint":m["manifest_fingerprint"]},

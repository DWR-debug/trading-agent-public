"""Second independent validation of the fixed 50/50 + 10% vol-budget candidate.

This module reuses the already validated calculation primitives from the first
candidate-validation control. Only the pre-registered universes change.
...
def run_validation(
    ...
    report = {
        "schema_version": 1,
        "diagnostic_type": "independent_candidate_validation_2026_09_23",
        "status": "COMPLETED",
        "candidate_status": (
        ...
        "preregistration": {
            "document": "docs/independent_validation_2026_09_23_preregistration.md",

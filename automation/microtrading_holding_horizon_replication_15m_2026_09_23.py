...
SYMBOLS = ("DOTUSDT", "ATOMUSDT", "UNIUSDT", "NEARUSDT")
...
def analyze(data_dir: Path, output_path: Path) -> dict[str, Any]:
    ...
    result = {
        "schema_version": 1,
        "research_type": "microtrading_holding_horizon_replication_15m",
        "status": "COMPLETED",
        "scope": {
...
def main() -> int:
    ...
    parser.add_argument(
        "--data-dir", default="data/micro_holding_horizon_replication_market_data"
    )
    parser.add_argument(
        "--output",
